...
var Button2 = exports.Button2 = function Button2(_ref) {
    var age = _ref.age,
...
var _ListWrapper = __webpack_require__(29);
...
var ToDoList = function (_React$Component) {
    ...
    _createClass(ToDoList, [{
        ...
        value: function buttonClick() {
            ...
            var inputValue = { text: this.input.value, id: this.id++ };
            inputValue && this.setState({ list: this.state.list.concat([inputValue]) });
            this.input.value = '';
        }
    }, {
        key: 'removeItem',
...
var ListWrapper = function (_React$Component) {
    ...
    _createClass(ListWrapper, [{
        key: 'parseList',
        value: function parseList(list, onDelete) {
            console.log(list);
        ...
        value: function render() {
            ...
            var parsedList = this.parseList(list, onDelete);
